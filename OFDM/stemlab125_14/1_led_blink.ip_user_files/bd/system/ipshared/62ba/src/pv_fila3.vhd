...
signal bits_alm : std_logic_vector(35 downto 0) := "000000000000000000000000000000000000";
        ...
        case estado_actual_mapeo is 
            when Estado1 => 
                ...
                if start = '1' then
                    ...
                    reset <= '1';
                    ready_mod <= '1';
                    bits_alm <= "000000000000000000000000000000000000"; 
                ...
                if estado_ant_mapeo = Estado1 then 
                    ...
                    if conta_mapeo < "101" then 
                        if selection_tx = "00" then 
                            bits_alm <= "00" & bits_alm(35 downto 2);
                        elsif selection_tx = "01" then 
                            bits_alm <= "0000" & bits_alm(35 downto 4);
                        end if;
                    else 
                        conta_mapeo <= "000"; 
                        band_sim <= '0';
...
begin
    ...
    elsif band_sim = '1' and selection_tx = "01" then
        case bits_alm(3 DOWNTO 0) is 
                when "0000" => 
                    dr  <= "1100001100000000";
                    di  <= "0100001100000000";
                when "0001" => 
