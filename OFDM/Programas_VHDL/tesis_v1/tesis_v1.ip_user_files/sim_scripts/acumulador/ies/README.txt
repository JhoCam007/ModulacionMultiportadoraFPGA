...
#
# Generated by export_simulation on Tue May 21 17:02:19 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './acumulador.sh' script.

./acumulador.sh -reset_run
...
./acumulador.sh -noclean_files

For more information on the script, please type './acumulador.sh -help'.
