...
#
# Generated by export_simulation on Wed May 22 17:13:28 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './my_multiplicador.sh' script.

./my_multiplicador.sh -reset_run
...
./my_multiplicador.sh -noclean_files

For more information on the script, please type './my_multiplicador.sh -help'.
