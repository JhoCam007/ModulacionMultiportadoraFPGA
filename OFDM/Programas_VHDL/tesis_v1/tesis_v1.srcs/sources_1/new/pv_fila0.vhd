...
signal b_real : std_logic_vector(15 downto 0)      := "0010111110001011";
...
with conta_filter select 
    b_real <= "0010111110001011" when "000",
              "0010111110001011" when "001",
              "0010111110001011" when "010",
              "0010111110001011" when "011",
              "0010111110001011" when "100",
              "0010111110001011" when "101",
              "0010111110001011" when others;

with conta_filter select 
    b_imag <=  "0000000000000000" when "000",
               "0000000000000000" when "001",
               "0000000000000000" when "010",
               "0000000000000000" when "011",
               "0000000000000000" when "100",
