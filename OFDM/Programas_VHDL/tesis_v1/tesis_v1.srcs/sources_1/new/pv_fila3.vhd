...
architecture Behavioral of pv_fila3 is
...
signal b_real : std_logic_vector(15 downto 0)      := "1010111110001011";
signal b_imag : std_logic_vector(15 downto 0)      := "0000000000000000";
attribute dont_touch of b_real : signal is "yes";
attribute dont_touch of b_imag : signal is "yes";
...
attribute dont_touch of dr : signal is "yes";
attribute dont_touch of di : signal is "yes";
...
with conta_filter select 
    b_real <= "0010111110001011" when "000",
              "1010111110001011" when "001",
              "0010111110001011" when "010",
              "1010111110001011" when "011",
              "0010111110001011" when "100",
              "1010111110001011" when "101",
              "1010111110001011" when others;

with conta_filter select 
    b_imag <=  "0000000000000000" when "000",
               "0000000000000000" when "001",
               "1000000000000000" when "010",
               "0000000000000000" when "011",
               "1000000000000000" when "100",
