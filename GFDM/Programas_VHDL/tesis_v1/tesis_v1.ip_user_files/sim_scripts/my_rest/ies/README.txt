...
#
# Generated by export_simulation on Tue May 21 17:38:54 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './my_rest.sh' script.

./my_rest.sh -reset_run
...
./my_rest.sh -noclean_files

For more information on the script, please type './my_rest.sh -help'.
