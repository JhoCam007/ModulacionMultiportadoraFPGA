...
HD_PWD='C:/Users/Jhonatan/Documents/basys/modulacion/tesis_v1/tesis_v1.runs/my_rest_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_rest.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_rest.tcl
