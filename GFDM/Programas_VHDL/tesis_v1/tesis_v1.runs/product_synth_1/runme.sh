...
HD_PWD='C:/Users/Jhonatan/Documents/basys/modulacion/tesis_v1/tesis_v1.runs/product_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log product.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source product.tcl
