...
HD_PWD='C:/Users/Jhonatan/Documents/basys/modulacion/tesis_v2/tesis_v1/tesis_v1.runs/my_multiplicador_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_multiplicador.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_multiplicador.tcl
