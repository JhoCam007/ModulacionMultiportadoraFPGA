...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/Henry/Documents/TesisV4.0-RedPitaya_1-GFDM/TesisV4.0-RedPitaya_1/Pitaya/redpitaya_guide-master/tmp/1_led_blink/1_led_blink.cache/compile_simlib/riviera"
  fi
