...
module system
  ...
  wire [13:0]top_level_0_binario;
  wire use_dac_0_dac_clk;
  wire [13:0]use_dac_0_dac_dat;
  wire use_dac_0_dac_rst;
  wire use_dac_0_dac_sel;
  wire use_dac_0_dac_wrt;
  ...
  assign dac_clk_o = use_dac_0_dac_clk;
  assign dac_dat_o[13:0] = use_dac_0_dac_dat;
  assign dac_rst_o = use_dac_0_dac_rst;
  assign dac_sel_o = use_dac_0_dac_sel;
  assign dac_wrt_o = use_dac_0_dac_wrt;
  ...
  system_top_level_0_11 top_level_0
       (.binario(top_level_0_binario),
        .clock(processing_system7_0_FCLK_CLK0));
  system_use_dac_0_1 use_dac_0
       (.aclk(processing_system7_0_FCLK_CLK0),
        .dac_clk(use_dac_0_dac_clk),
        .dac_dat(use_dac_0_dac_dat),
        .dac_rst(use_dac_0_dac_rst),
        .dac_sel(use_dac_0_dac_sel),
        .dac_wrt(use_dac_0_dac_wrt),
        .data_dac(top_level_0_binario),
