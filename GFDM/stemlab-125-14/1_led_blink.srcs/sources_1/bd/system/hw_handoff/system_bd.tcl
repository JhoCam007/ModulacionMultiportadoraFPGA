...
proc create_root_design { parentCell } {
  ...
  set top_level_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:top_level:1.0 top_level_0 ]

  set_property -dict [ list \
   CONFIG.FREQ_HZ {125000000} \
 ] [get_bd_pins /top_level_0/clock]

  # Create instance: use_dac_0, and set properties
  set use_dac_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:use_dac:1.0 use_dac_0 ]

  set_property -dict [ list \
   CONFIG.FREQ_HZ {125000000} \
 ] [get_bd_pins /use_dac_0/aclk]

  set_property -dict [ list \
   CONFIG.FREQ_HZ {250000000} \
 ] [get_bd_pins /use_dac_0/dac_clk]

  set_property -dict [ list \
   CONFIG.FREQ_HZ {250000000} \
 ] [get_bd_pins /use_dac_0/ddr_clk]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins use_dac_0/ddr_clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins use_dac_0/locked]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins top_level_0/clock] [get_bd_pins use_dac_0/aclk]
  connect_bd_net -net top_level_0_binario [get_bd_pins top_level_0/binario] [get_bd_pins use_dac_0/data_dac]
  connect_bd_net -net use_dac_0_dac_clk [get_bd_ports dac_clk_o] [get_bd_pins use_dac_0/dac_clk]
  connect_bd_net -net use_dac_0_dac_dat [get_bd_ports dac_dat_o] [get_bd_pins use_dac_0/dac_dat]
  connect_bd_net -net use_dac_0_dac_rst [get_bd_ports dac_rst_o] [get_bd_pins use_dac_0/dac_rst]
  connect_bd_net -net use_dac_0_dac_sel [get_bd_ports dac_sel_o] [get_bd_pins use_dac_0/dac_sel]
  connect_bd_net -net use_dac_0_dac_wrt [get_bd_ports dac_wrt_o] [get_bd_pins use_dac_0/dac_wrt]
